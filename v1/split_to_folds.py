...
training_data = np.load("./dataset/training_data_mel.npy")
training_labels = np.load("./dataset/training_labels_mel.npy")
...
split_to_folds(training_labels, "labels")
split_to_folds(training_data, "data")
